...
public class AzureVMTemplateBuilder extends AzureVMTemplateFluent<AzureVMTemplateBuilder> {
    ...
    public AzureVMAgentTemplate build() {
        return new AzureVMAgentTemplate(fluent.getName(),
                ...
                fluent.getAdvancedImage().getJoinDomain(),
                fluent.getAdvancedImage().getDomainName(),
                fluent.getAdvancedImage().getDomainOU(),
                fluent.getAdvancedImage().getJoinDomainCredentialsId(),
                fluent.getWorkspace(),
